...
data = pd.read_csv("SMSSpamCollection.csv", names=["label", "message"])
...
print(f'Shape of preprocessed data matrix: {X.shape}')
...
test_string = ["Hey there, this is an email informing u that u won lottery n earnt money."]
	# [input('Enter test sentence to classify:')]
